...
C = read.big.matrix("cpm/breast.cancer.csv", type='double', has.row.names=TRUE)
N = read.big.matrix("cpm/breast.cancer.csv", type='double', has.row.names=TRUE)
# N = readRDS("cpm/breast.cancer.rds")
