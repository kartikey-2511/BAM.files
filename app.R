...
ui <- fluidPage(
	...
	sidebarLayout(
		...
		sidebarPanel(
			br(),
			h4(strong("Note:"), " The datasets represented here are for", strong(" Breast"), " and", strong(" Pancreas cancer"), " patients."),
			br(),
